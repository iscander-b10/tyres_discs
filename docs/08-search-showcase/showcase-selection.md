...
На широкой колонке (`data-layout='horizontal'`, панель ≥ 1100px, форма поиска сверху) featured-слайды 320–340px, snap к началу ряда, fade-mask на обрезанных краях, стрелки **по бокам** ряда карточек. В узкой колонке (`data-layout='sidebar'`, 769–1099px, вертикальная форма слева) та же ширина слайда, snap к центру: первая карточка у левого края с peek справа, при листании — карточка по центру с обрезанными соседями и тем же fade; стрелки в шапке рядом с заголовком. На мобилке (`max-width: 560px`) одна крупная карточка + peek, без стрелок и без fade-mask.
