...
На широкой колонке (`data-layout='horizontal'`, панель ≥ 1100px, форма поиска сверху) featured-слайды 320–340px, snap к началу ряда, fade-mask на обрезанных краях, стрелки **по бокам** ряда карточек. В узкой колонке (`data-layout='sidebar'`, 769–1099px, вертикальная форма слева) та же ширина слайда, пока колонка showcase шире 700px; стрелки в шапке рядом с заголовком. Когда колонка showcase ≤ 700px (узкий sidebar, stacked, мобилка) — **одна карточка на всю ширину** ряда, snap к началу, без peek соседа и без fade-mask; на viewport ≤ 560px стрелки скрыты (свайп + progress).
